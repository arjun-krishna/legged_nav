...
class ObstacleManager:
    ...
    def __init__(self, cfg: LeggedRobotNavCfg.obstacle, device: str) -> None:
        ...
        self.asset_shape = np.zeros((self.get_num_obstacles(), ))
    ...
    def create_obstacles(self, gym, sim, env_handle, i):
        ...
        for _ in range(self.cfg.static.num):
            ...
            obstacles['static']['shapes'].append(shape)
        ...
        for _ in range(self.cfg.magic_spawn.num):
            ...
            obstacles['magic_spawn']['shapes'].append(shape)
        ...
        for _ in range(self.cfg.dynamic.num):
            ...
            obstacles['dynamic']['shapes'].append(shape)
    ...
    def reset_obstacles(self, obstacle_handles, env_ids):
        ...
        for env_id in env_ids:
            ...
            shapes = obstacle_handles[env_id]['static']['shapes']
            ...
            reset_pos_vel[curr_id:curr_id+self.cfg.static.num, 2] = torch.tensor(shapes)[:,2].to(self.device)/2
